...
- Docs site: `apps/site` (docs in `apps/site/docs`; generated output in `apps/site/generated-static`; API reference markdown generated by `pnpm lib:build-docs` into `apps/site/generated-api` and served at `/api`).
...
- Forbidden targets: `**/dist/**`, `apps/site/generated-api/**`, `packages/*/coverage/**`, `apps/site/.docusaurus/**`, `apps/site/build/**`, `apps/site/generated-static/**`.
