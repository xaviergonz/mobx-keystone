...
Middleware registration changes take effect when the next action or flow step collects its middleware chain. Registering or disposing middleware during a call does not change the chain already executing that call.
