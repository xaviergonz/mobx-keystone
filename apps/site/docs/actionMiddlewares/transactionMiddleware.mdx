...
The transaction middleware allows you to mark model actions/flows as transactions, meaning that if such an action/flow throws, any changes performed during it will be reverted before the exception is rethrown.
