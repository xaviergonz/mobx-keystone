...
- It establishes this tree as the live boundary of your application state.
- It gives models a reliable place to start and dispose app-wide side effects.

Registration is recommended for a long-lived application store, but it is not required to create models, take snapshots, or attach middleware to a tree.
