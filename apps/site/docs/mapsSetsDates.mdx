...
### Property transforms (`.withTransform(...)`) {#deprecated-property-transforms}
...
### Built-in transform helpers {#deprecated-built-in-transforms}
...
### Collection models (`ObjectMap` / `ArraySet`) {#deprecated-collection-models}
