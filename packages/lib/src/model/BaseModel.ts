...
> {
  ...
  constructor(data: CreationData) {
    // fake constructor, actual construction will be done on the
    // inherited class generated by the model decorator

    if ((data as any) !== modelConstructorSymbol) {
      throw failure("did you forget to add the @model decorator?")
    }
  }
}
