...
route: /models/traversingTheTree
menu: Models
---

# Models / Traversing the Tree
...
Besides the aforementioned `isTreeNode(value: object)` method, there's also the `detach(value: object)` method, which allows a node to get detached from its parent following this logic:
