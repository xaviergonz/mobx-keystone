...
`mobx-keystone`, when not using runtime type checking, uses standard Typescript type annotations to declare the data of models, therefore lowering the learning curv.
