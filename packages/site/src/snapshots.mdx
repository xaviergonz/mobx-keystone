...
### `fromSnapshot<T>(sn: SnapshotInOf<T>, options?: FromSnapshotOptions): T` / `fromSnapshot<TType>(type: TType, sn: SnapshotInOf<TypeToData<TType>>, options?: FromSnapshotOptions): T`
