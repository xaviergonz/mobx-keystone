...
Returns all the children objects (this is, excluding primitives) of an object. Pass the options object with the `deep` option (defaults to false) set to true to get the children deeply or false to get them shallowly.
